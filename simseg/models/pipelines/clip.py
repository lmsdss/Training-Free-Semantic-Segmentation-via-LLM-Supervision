...
class CLIPModel(nn.Module):
    def __init__(self, cfg, rank):
        ...
        self.image_projection = ProjectionHead(
            cfg, embedding_dim=cfg.model.image_encoder.embedding_dim, projection_dim=cfg.model.projection.dim,
            trainable=cfg.model.projection.image_projector_trainable
        )
        self.text_projection = ProjectionHead(
            cfg, embedding_dim=cfg.model.text_encoder.embedding_dim, projection_dim=cfg.model.projection.dim,
            trainable=cfg.model.projection.text_projector_trainable
        )
